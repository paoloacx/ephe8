/*
 * main.js (v4.22 - Fix Save Memory UI Call)
...
async function checkAndRunApp() {
    console.log("Iniciando Ephemerides v4.22 (Fix Save UI Call)..."); // Cambiado
...
async function handleSaveMemorySubmit(diaId, memoryData, isEditing) {
    ...
    try {
        ...
        // ***** CAMBIO: Quitar llamada a ui._showMemoryForm *****
        ui.resetMemoryForm(); 
        // ui._showMemoryForm(false); // <--- LÍNEA ELIMINADA
        // ***** FIN CAMBIO *****
